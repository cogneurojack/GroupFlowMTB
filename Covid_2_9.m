...
%     EEG = pop_epoch( EEG, {  '1  0  0'  }, [-1  118], 'newname', 'test', 'epochinfo', 'yes');
%     [ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, 2,'savenew','D:\\SSMZ\\01\\test.set','gui','off');
%     EEG = eeg_checkset( EEG );
%     EEG = pop_rmdat( EEG, {EEG.event(epoch).type}, [-1 epoch_trial],0 );
%     [ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, 2,'savenew', filename_trial,'gui','off');
