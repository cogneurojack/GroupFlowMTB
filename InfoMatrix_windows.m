...
sData = readtable('D:/groupFlow_B/allSurveyClean.csv');

matrixFolder = 'D:/groupFlow_S/';
outputFolder = 'D:/';
infoMat=[];
% % TEST FOLDERS
...
%% LOAD FILE AND SET OUTPUT FILE VAUES AND SIZE
    for i = 1:numFiles     
        ...
        cd('C:\Users\moore\OneDrive - Goldsmiths College\Projects\Group Flow\GroupFlowMTB');
